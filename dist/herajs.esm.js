...
var rpc_pb_14 = rpc_pb.KeyParams;
...
function encodeTxHash(bytes) {
  return bs58.encode(Buffer$2.from(bytes));
}
...
function () {
  function Address(address) {
    ...
    if (address instanceof Address) {
      // Copy buffer
      this.value = Buffer$2.from(address.value);
    } else if (typeof address === 'string') {
      if (address.length <= ACCOUNT_NAME_LENGTH) {
        this.value = Buffer$2.from(address); // .padEnd(ACCOUNT_NAME_LENGTH, "\0")
      } else {
        this.value = Address.decode(address);
      }

      this.encoded = address;
    } else if (address instanceof Buffer$2) {
      // Treat array-like as buffer
      this.value = address;
    } else if (address instanceof Uint8Array) {
      // Treat array-like as buffer
      this.value = Buffer$2.from(address);
    } else {
    ...
    if (arrValue.length <= ACCOUNT_NAME_LENGTH) {
      this.isName = true;
      this.value = Buffer$2.from(arrValue);
    }
  }
  ...
  _createClass(Address, [{
    ...
    value: function toString() {
      ...
      if (this.isName) {
        this.encoded = Buffer$2.from(this.value).toString();
        return this.encoded;
      } // Account address
    ...
    value: function decode(bs58string) {
      ...
      return Buffer$2.from(decoded.slice(1));
    }
  }, {
    key: "encode",
    value: function encode(byteArray) {
      ...
      var buf = Buffer$2.from([ADDRESS_PREFIXES.ACCOUNT].concat(_toConsumableArray(byteArray)));
    ...
    value: function fromGrpc(grpcObject) {
      ...
      return new Block({
        ...
        header: _objectSpread({}, obj.header, {
          chainid: Buffer$2.from(grpcObject.getHeader().getChainid_asU8()).toString('utf8'),
  ...
  _createClass(Tx, [{
    ...
    value: function toGrpc() {
      ...
      if (this.payload != null) {
        msgtxbody.setPayload(Buffer$2.from(this.payload));
      }

      if (typeof this.sign === 'string') {
        msgtxbody.setSign(Buffer$2.from(this.sign, 'base64'));
      } else {
      ...
      if (typeof this.chainIdHash === 'string') {
        ...
        hashBuffer = new Uint8Array(Buffer$2.from(this.chainIdHash));
      }
      ...
      if (this.hash != null) {
        ...
        if (typeof hash === 'string') {
          _hashBuffer = new Uint8Array(Buffer$2.from(decodeTxHash(hash)));
        } else {
          _hashBuffer = new Uint8Array(Buffer$2.from(hash));
        }
  ...
  _createClass(FilterInfo, [{
    ...
    value: function toGrpc() {
      ...
      if (this.args) {
        ...
        fi.setArgfilter(Buffer$2.from(argsAsJson));
      }
    ...
    value: function fromGrpc(grpcObject) {
      return new FilterInfo({
        args: JSON.parse(Buffer$2.from(grpcObject.getArgfilter_asU8()).toString()),
        address: new Address(grpcObject.getContractaddress_asU8()),
        eventName: grpcObject.getEventname(),
  ...
  _createClass(AergoClient, [{
    ...
    value: function () {
      var _getChainIdHash = _asyncToGenerator(function* (enc) {
        ...
        if (enc === 'base58') {
          return bs58.encode(Buffer$2.from(hash));
        }

        return hash;
      });

      return function getChainIdHash(_x2) {
      ...
      function () {
        var _unmarshal = _asyncToGenerator(function* (response) {
          if (typeof _this.chainIdHash === 'undefined') {
            ...
            _this.setChainIdHash(Buffer$2.from(response.getBestChainIdHash_asU8()));
          }
    ...
    value: function getNodeState(component) {
      ...
      function () {
        var _marshal = _asyncToGenerator(function* (component) {
          ...
          if (typeof component !== 'undefined') {
            params.setComponent(Buffer$2.from(component));
          }

          return params;
        });

        return function marshal(_x5) {
      ...
      function () {
        var _unmarshal3 = _asyncToGenerator(function* (response) {
          return JSON.parse(Buffer$2.from(response.getValue_asU8()).toString());
        });
      ...
      return promisify(this.client.client.getVotes, this.client.client)(params).then(function (state) {
        return state.getVotesList().map(function (item) {
          return {
            ...
            candidate: bs58.encode(Buffer$2.from(item.getCandidate_asU8()))
          };
        });
      });
    }
    ...
    value: function queryContract(functionCall) {
      ...
      return promisify(this.client.client.queryContract, this.client.client)(query).then(function (grpcObject) {
        return JSON.parse(Buffer$2.from(grpcObject.getValue()).toString());
      });
    }
    /**
      ...
      return promisify(this.client.client.queryContractState, this.client.client)(query).then(function (grpcObject) {
        ...
        if (list.length === 1) {
          ...
          if (varProof.getInclusion() === false) {
            ...
            throw Error("queried variable ".concat(query.getStoragekeysList()[0], " does not exist in state at address ").concat(addr.toString()));
          }

          var value = varProof.getValue_asU8();

          if (value.length > 0) {
            return JSON.parse(Buffer$2.from(value).toString());
          }
        }
    ...
    value: function getServerInfo(keys) {
      ...
      /*#__PURE__*/
      function () {
        var _marshal3 = _asyncToGenerator(function* (keys) {
        ...
        return function marshal(_x10) {
          return _marshal3.apply(this, arguments);
        };
      ...
      function () {
        ...
        return function unmarshal(_x11) {
...
/*#__PURE__*/
function () {
  function StateQuery(contractInstance, storageKeys) {
...
export { AergoClient, GrpcProvider, constants, Contract, Address, Amount, Tx };
