...
export class InternalStat extends jspb.Message {
  getName(): string;
  ...
  toObject(includeInstance?: boolean): InternalStat.AsObject;
  static toObject(includeInstance: boolean, msg: InternalStat): InternalStat.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: InternalStat, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): InternalStat;
  static deserializeBinaryFromReader(message: InternalStat, reader: jspb.BinaryReader): InternalStat;
}

export namespace InternalStat {
...
export class ModuleStatus extends jspb.Message {
  ...
  clearStatList(): void;
  getStatList(): Array<InternalStat>;
  setStatList(value: Array<InternalStat>): void;
  addStat(value?: InternalStat, index?: number): InternalStat;
...
export namespace ModuleStatus {
  export type AsObject = {
    name: string,
    statList: Array<InternalStat.AsObject>,
  }
}

export class NodeStatus extends jspb.Message {
  clearStatusList(): void;
  getStatusList(): Array<ModuleStatus>;
  setStatusList(value: Array<ModuleStatus>): void;
  addStatus(value?: ModuleStatus, index?: number): ModuleStatus;
...
export namespace NodeStatus {
  export type AsObject = {
    statusList: Array<ModuleStatus.AsObject>,
  }
}
